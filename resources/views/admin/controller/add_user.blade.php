...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Controller /</span> Add User</h4>
      <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <form method="POST" action="{{ route('AdminUser.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            ></span>
                            <x-text-input id="name" class="form-control" type="text" placeholder="3omda" name="name" :value="old('name')" required autofocus autocomplete="name" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <x-text-input id="email" class="form-control" placeholder="3omda@example.com" type="email" name="email" :value="old('email')" required autocomplete="username" />
                          </div>
                          @if ($errors->has('email'))
